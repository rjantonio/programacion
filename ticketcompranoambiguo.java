public class ticketcompranoambiguo {
  public static void main(String[]args) {
    ...
    preciot3 = precio3*cantidad3;
    preciot4 = precio4*cantidad4;
    
    preciosiniva = preciot1 + preciot2 + preciot3 + preciot4;
    ivatotal = precioconiva1 + precioconiva2 + precioconiva3 + precioconiva4;
    preciototal = preciosiniva + ivatotal;
    
    System.out.printf("%-10s %10s %10s %10s %10s", "Nombre" , "Cantidad" , "Precio" , "PrecioTotal" , "IVA\n");
    System.out.printf("%-10s %10d %10.2f %10.2f %10.2f\n", nombre1 , cantidad1 , precio1 , preciot1 , precioconiva1);
    System.out.printf("%-10s %10d %10.2f %10.2f %10.2f\n", nombre2 , cantidad2 , precio2 , preciot2 , precioconiva2);
    System.out.printf("%-10s %10d %10.2f %10.2f %10.2f\n", nombre3 , cantidad3 , precio3 , preciot3 , precioconiva3);
    System.out.printf("%-10s %10d %10.2f %10.2f %10.2f\n", nombre4 , cantidad4 , precio4 , preciot4 , precioconiva4);
